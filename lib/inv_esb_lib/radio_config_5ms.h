...
#define RADIO_RTC_EVENT_TICKS		               10   // 10ms, 0.5ms per tick
			

#define CENTRAL_TIMER_SCAN_US		               4500 //4.5ms, 1 us per tick		
#define PERIPH_TIMER_SCAN_US		               900 //900us, 1 us per tick			
