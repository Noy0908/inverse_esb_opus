...
#ifndef _OPUS_APPLICATION_CONFIG_H
#define _OPUS_APPLICATION_CONFIG_H
...
#define CONFIG_OPUS_HEADER_ENABLED 0
// </h>

#define CONFIG_OPUS_CHANNELS 2
...
#endif /* _OPUS_APPLICATION_CONFIG_H */
