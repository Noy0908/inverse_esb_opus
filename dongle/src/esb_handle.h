...
/* Size of a block for 5 ms of audio data. */
#define BLOCK_SIZE(_sample_rate, _number_of_ms) \
	(BYTES_PER_SAMPLE * (_sample_rate / 200) * _number_of_ms)
...
#define ESB_BLOCK_COUNT             100

#define FRAME_SIZE                 (BYTES_PER_SAMPLE *  (MAX_SAMPLE_RATE / 1000))
#define PCM_BLOCK_COUNT				1000
